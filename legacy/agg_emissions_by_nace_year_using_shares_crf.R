...
load(paste0(proc_data, "/emissions_from_energy_by_nace_year_using_shares_crf.RData"))
load(paste0(proc_data, "/emissions_from_ind_process_by_nace_year.RData"))

# Clean data -----

agg_emissions_by_nace_year_using_shares_crf <- emissions_from_energy_by_nace_year %>%
