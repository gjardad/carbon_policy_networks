...
## This code simulates change in emissions from reallocation effect
...
# Compute emission reduction from reallocation -----

cov_from_targeted_firm <- x %*% (io_matrix %*% (psi_exposure[,j] * psi_e) - (io_matrix %*% psi_exposure[,j])*(io_matrix %*% psi_e))
